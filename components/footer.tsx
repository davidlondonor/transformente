const Footer = () => {
	const navigation = {
		social: [
			...
			{
				name: "Instagram",
				href: "https://www.instagram.com/nathaliamirandaortiz/",
				icon: (props: any) => (
					<svg fill="currentColor" viewBox="0 0 24 24" {...props}>
						<path
							fillRule="evenodd"
			...
			{
				name: "Linkedin",
				href: "https://www.linkedin.com/in/nathalia-miranda",
				icon: (props: any) => (
	...
	return (
		<footer className="bg-white">
			<div className="max-w-7xl mx-auto pb-6 px-4 overflow-hidden sm:px-6 lg:px-8">
				...
				<p className="mt-6 text-center font-normal text-sm text-gray-400">
					&copy; 2022 Transformente. Todos los derechos reservados.
				</p>
			</div>
		</footer>
	);
